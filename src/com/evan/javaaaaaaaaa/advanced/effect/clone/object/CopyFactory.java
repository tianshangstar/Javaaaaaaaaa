...
public class CopyFactory {
    ...
    /**
     * copy工厂，代码实现和CopyConstructor一致，只是由构造方法变更为静态工厂
     *
     * @param src
     */
    public static CopyFactory getCopyInstance(CopyFactory src) throws CloneNotSupportedException {
        CopyFactory dest = new CopyFactory();
    ...
    public static void main(String[] args) throws CloneNotSupportedException, IOException, ClassNotFoundException {
        CopyFactory ca = new CopyFactory();
        CopyFactory ca_clone = CopyFactory.getCopyInstance(ca);
